...
import static com.deadormi.util.ModificaGruppoFilter.log;
 ...
 * @author Timbu
 */
public class CreaPdfFilter implements Filter {
    ...
    public CreaPdfFilter() {
    }    
    
    private void doBeforeProcessing(ServletRequest request, ServletResponse response)
            throws IOException, ServletException {
        if (debug) {
            log("CreaPdfFilter:DoBeforeProcessing");
        }
    ...
    private void doAfterProcessing(ServletRequest request, ServletResponse response)
            throws IOException, ServletException {
        if (debug) {
            log("CreaPdfFilter:DoAfterProcessing");
        }
    ...
    public void init(FilterConfig filterConfig) {        
        ...
        if (filterConfig != null) {
            if (debug) {                
                log("CreaPdfFilter:Initializing filter");
            }
        }
    }
    ...
    public String toString() {
        if (filterConfig == null) {
            return ("CreaPdfFilter()");
        }
        StringBuffer sb = new StringBuffer("CreaPdfFilter(");
